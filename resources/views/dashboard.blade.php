        ...
        <table>
            <tr>
                ...
                <td class='tdPersonalInfo'>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href={{ url('/loadChatroom') }} class="btn btn-outline-light fw-bold mt-2 mb-2"
                                            style="width: 92%">Obrolan</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href={{ url('/loadEditCalendar') }} class="btn btn-outline-light mb-2 fw-bold"
                                            style="width: 92%">Kalender</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ url('/listKontrak/pengerjaan') }}"
                                            class="btn btn-outline-light fw-bold" style="width: 92%">List Kontrak</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="card mt-3 infoUang bg-warning">
                        <div class="card-body">
                            <div class='border border-light rounded' style="padding:5px;">
