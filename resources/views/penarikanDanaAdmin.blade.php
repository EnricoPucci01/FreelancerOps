                ...
                <h3 class="card-title">Tarik Dana</h5>
                    <form action={{ url('/penarikanDanaAdmin') }} method="POST">
                            ...
                            <tr>
                                <td>
                                    <div class="input-group mb-3">
                                        <select class="form-select" name="no_rek" id="norek"
                        ...
                        <button type="button" class="btn btn-primary" style="margin-top: 10px" id='myBtn'
                            data-bs-target="#modalTarik" data-bs-toggle="modal">Tarik</button>
                        ...
                        <div class="modal fade" tabindex="-1"aria-hidden="true" id="modalTarik">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Anda akan melakukan penarikan dana sejumlah <b></b>, Melalui bank <b></b> nomor
                                        rekening <b></b>. <br>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-body">
                                        Anda akan melakukan penarikan dana sejumlah <b>` + formatedStr +
                                        `</b>, Melalui bank <b>` + bank + `</b> dengan nomor rekening <b>` + norek + `</b>. <br>
