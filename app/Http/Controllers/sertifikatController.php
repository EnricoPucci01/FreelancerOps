...
class sertifikatController extends Controller
{
    public function insertSertifikat(Request $request){
        ...
        if($request->file('fileSertifikat') != null && $request->input('judul') != null && $request->input('desc_sertifikat')!= null){
            ...
            return redirect()->back()->with('error','File Sertifikat, Nama Sertifikat, Deskripsi Sertifikat  tidak dapat kosong');
        }
    }
